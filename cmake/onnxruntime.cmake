  ...
  if(DEFINED ENV{SHERPA_ONNXRUNTIME_LIB_DIR})
    ...
    elseif(WIN32)
      if(SHERPA_ONNX_ENABLE_GPU)
	    ...
	    set(location_onnxruntime_lib $ENV{SHERPA_ONNXRUNTIME_BIN_DIR}/onnxruntime.dll)
        set(location_onnxruntime_lib2 $ENV{SHERPA_ONNXRUNTIME_LIB_DIR}/onnxruntime.lib)
    ...
    if(NOT EXISTS ${location_onnxruntime_lib})
      ...
      if(NOT EXISTS ${location_onnxruntime_lib})
        # Try framework-style path (onnxruntime 1.26.0+)
        set(location_onnxruntime_lib $ENV{SHERPA_ONNXRUNTIME_LIB_DIR}/onnxruntime.framework/onnxruntime)
        if(NOT EXISTS ${location_onnxruntime_lib})
          message(FATAL_ERROR "neither libonnxruntime.a nor onnxruntime.framework/onnxruntime found in $ENV{SHERPA_ONNXRUNTIME_LIB_DIR}")
        endif()
      endif()
      set(onnxruntime_lib_files ${location_onnxruntime_lib})
